...
public class PeripheralConfigurationView extends ConfigurationView {
	...
	private void initComponents() {
		...
		drawerConfigPanel
				.setBorder(BorderFactory.createTitledBorder(Messages.getString("PeripheralConfigurationView.4"))); //$NON-NLS-1$
		...
		customerDisplayPanel
				.setBorder(BorderFactory.createTitledBorder(Messages.getString("PeripheralConfigurationView.5"))); //$NON-NLS-1$
		...
		btnTest.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DrawerUtil.setCustomerDisplayMessage(tfCustomerDisplayPort.getText(),
						tfCustomerDisplayMessage.getText());
			}
		});
		...
		scaleDisplayPanel
				.setBorder(BorderFactory.createTitledBorder(Messages.getString("PeripheralConfigurationView.15"))); //$NON-NLS-1$
		...
		OrderServiceExtension orderServicePlugin = (OrderServiceExtension) ExtensionManager
