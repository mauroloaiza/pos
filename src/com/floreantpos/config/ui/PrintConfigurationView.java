...
public class PrintConfigurationView extends ConfigurationView {
	...
	private void setSelectedPrinter(JComboBox whichPrinter, String printerName) {
		...
		// String printerName = AppConfig.getString(propertyName,
		// osDefaultPrinter.getName());
	...
	public boolean save() throws Exception {
		...
		// AppConfig.put(PrintConfig.REPORT_PRINTER_NAME, printService == null ?
		// null : printService.getName());
		...
		// AppConfig.put(PrintConfig.RECEIPT_PRINTER_NAME, printService == null
		// ? null : printService.getName());

		// printService = (PrintService) cbKitchenPrinterName.getSelectedItem();
		// AppConfig.put(PrintConfig.KITCHEN_PRINTER_NAME, printService == null
		// ? null : printService.getName());
