...
public class VirtualPrinterConfigDialog extends POSDialog {
	...
	// private JCheckBox cbTakeOut = new
	// JCheckBox(OrderType.TAKE_OUT.toString());
	// private JCheckBox cbPickup = new JCheckBox(OrderType.PICKUP.toString());
	// private JCheckBox cbHomeDeli = new
	// JCheckBox(OrderType.HOME_DELIVERY.toString());
	// private JCheckBox cbDriveThru = new
	// JCheckBox(OrderType.DRIVE_THRU.toString());
