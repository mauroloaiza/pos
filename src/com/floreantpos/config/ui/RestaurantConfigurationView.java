...
public class RestaurantConfigurationView extends ConfigurationView {
	...
	public RestaurantConfigurationView() {
		...
		JPanel contentPanel = new JPanel(
				new MigLayout("fillx", "[][grow][][grow]", "[][][][][][][][][][][][][][][][][]")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		// JLabel lblCurrencyName = new
		// JLabel(Messages.getString("RestaurantConfigurationView.30") + ":");
		// //$NON-NLS-1$ //$NON-NLS-2$
		// contentPanel.add(lblCurrencyName, "cell 0 10,alignx trailing");
		// //$NON-NLS-1$

		// tfCurrencyName = new POSTextField();
		// contentPanel.add(tfCurrencyName, "growx,cell 1 10"); //$NON-NLS-1$

		// JLabel lblCurrencySymbol = new
		// JLabel(Messages.getString("RestaurantConfigurationView.37") + ":");
		// //$NON-NLS-1$ //$NON-NLS-2$
		// contentPanel.add(lblCurrencySymbol, "cell 2 10,alignx trailing");
		// //$NON-NLS-1$
