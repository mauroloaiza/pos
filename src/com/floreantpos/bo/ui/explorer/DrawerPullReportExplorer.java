...
public class DrawerPullReportExplorer extends TransparentPanel {
				...
				try {
					...
					if (selectedRow < 0) {
						BOMessageDialog.showError(DrawerPullReportExplorer.this,
								Messages.getString("DrawerPullReportExplorer.1")); //$NON-NLS-1$
						return;
					}
	...
	class DrawerPullExplorerTableModel extends ListTableModel {
		String[] columnNames = { com.floreantpos.POSConstants.ID, com.floreantpos.POSConstants.TIME, "TICKET COUNT", //$NON-NLS-1$
				com.floreantpos.POSConstants.DRAWER_PULL_AMOUNT, "USER ID", "TERMINAL ID", "BEGIN CASH", "NET SALES", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				"SALES TAX", "CASH TAX", "TOTAL REVENUE", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				"GROSS RECEIPTS", "GIFT CERT RETURN COUNT", "GIFT CERT RETURN AMOUNT", "GIFT CERT CHARGE AMOUNT", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				"CASH RECEIPT NO", "CASH RECEIPT AMOUNT", //$NON-NLS-1$ //$NON-NLS-2$
				"CREDIT CARD RECEIPT NO", "CREDIT CARD RECEIPT AMOUNT", "DEBIT CARD RECEIPT NO", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				"DEBIT CARD RECEIPT AMOUNT", "REFUND RECEIPT COUNT", //$NON-NLS-1$ //$NON-NLS-2$
				"REFUND AMOUNT", "RECEIPT DIFFERENTIAL", "CASH BACK", "CASH TIPS", "CHARGED TIPS", "TIPS PAID", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
				"TIPS DIFFERENTIAL", "PAY OUT NO", //$NON-NLS-1$ //$NON-NLS-2$
				"PAY OUT AMOUNT", "DRAWER BLEED NO", "DRAWER BLEED AMOUNT", com.floreantpos.POSConstants.ACTUAL_AMOUNT, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				"VARIANCE", "TOTAL VOIDWST", //$NON-NLS-1$ //$NON-NLS-2$
				"TOTAL VOID", "TOTAL DISCOUNT COUNT", "TOTAL DISCOUNT AMOUNT", "TOTAL DISCOUNT SALES", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				"TOTAL DISCOUNT GUEST", "TOTAL DISCOUNT PARTY SIZE", //$NON-NLS-1$ //$NON-NLS-2$
