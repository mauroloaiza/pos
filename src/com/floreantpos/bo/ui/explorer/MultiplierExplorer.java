...
public class MultiplierExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (multiplier.isMain())
						return;
					if (ConfirmDeleteDialog.showMessage(MultiplierExplorer.this,
	...
	class MultiplierExplorerTableModel extends AbstractTableModel {
		String[] columnNames = { POSConstants.NAME, "Prefix", POSConstants.RATE, POSConstants.SORT_ORDER,
				POSConstants.BUTTON_COLOR, POSConstants.TEXT_COLOR, "Default" };
