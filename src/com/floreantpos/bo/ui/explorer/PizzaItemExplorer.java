...
public class PizzaItemExplorer extends TransparentPanel {
	...
	public PizzaItemExplorer() {
		...
		// tableModel.addColumn(POSConstants.PRICE.toUpperCase() + " (" +
		// CurrencyUtil.getCurrencySymbol() + ")", "price"); //$NON-NLS-1$
		// //$NON-NLS-2$ //$NON-NLS-3$
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (POSMessageDialog.showYesNoQuestionDialog(PizzaItemExplorer.this, POSConstants.CONFIRM_DELETE,
