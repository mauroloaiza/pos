...
public class PizzaModifierExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog.showMessage(PizzaModifierExplorer.this,
	...
	private class PizzaModifierExplorerModel extends ListTableModel {
		...
		public PizzaModifierExplorerModel() {
			...
			super(new String[] { com.floreantpos.POSConstants.ID, com.floreantpos.POSConstants.NAME,
					POSConstants.TRANSLATED_NAME,
					// com.floreantpos.POSConstants.PRICE + " (" +
					// currencySymbol + ")",
					// com.floreantpos.POSConstants.EXTRA_PRICE, //$NON-NLS-1$
					// //$NON-NLS-2$
					com.floreantpos.POSConstants.TAX + "(%)", com.floreantpos.POSConstants.MODIFIER_GROUP, //$NON-NLS-1$
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			/*
			 * case 3: return Double.valueOf(modifier.getPrice());
			 * 
			 * case 4: return Double.valueOf(modifier.getExtraPrice());
			 */
	...
	protected ModifierGroup getSelectedModifierGroup(ModifierGroup defaultValue) {
		...
		ComboItemSelectionDialog dialog = new ComboItemSelectionDialog("SELECT MODIFIER GROUP", "Modifier Group",
