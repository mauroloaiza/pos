...
public class GratuityViewer2 extends TransparentPanel implements ActionListener {
	...
	private void $$$setupUI$$$() {
		...
		contentPane.add(cbUsers,
				new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
						...
						new Dimension(406, 22), null, 0, false));
		btnGo = new JButton();
		...
		contentPane.add(separator1,
				new GridConstraints(1, 0, 1, 3, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL,
		...
		contentPane.add(separator3,
				new GridConstraints(7, 0, 1, 3, GridConstraints.ANCHOR_SOUTH, GridConstraints.FILL_HORIZONTAL,
						GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0,
						false));
		btnPay = new JButton();
		btnPay.setText(com.floreantpos.POSConstants.PAY);
		contentPane.add(btnPay,
				new GridConstraints(8, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
						GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
						GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
	}
	...
	private class GratuityTableModel extends ListTableModel {
		...
		public GratuityTableModel(List<Gratuity> gratuities) {
			super(new String[] { com.floreantpos.POSConstants.FIRST_NAME, com.floreantpos.POSConstants.LAST_NAME,
					com.floreantpos.POSConstants.TICKET_ID, com.floreantpos.POSConstants.AMOUNT }, gratuities);
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (com.floreantpos.POSConstants.PAY.equalsIgnoreCase(actionCommand)) {
			try {
				...
				ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.PAY_TIPS,
						actionMessage);
