...
public class LanguageSelectionDialog extends POSDialog {
	...
	private void updateModel() {
		if (TerminalConfig.getDefaultLocale() != null) {
			 ...
			 * StringTokenizer st = new StringTokenizer(getLocale, "_"); if
			 * (st.hasMoreTokens()) language = st.nextToken(); if
			 * (st.hasMoreTokens()) country = st.nextToken(); if
			 * (st.hasMoreTokens()) variant = st.nextToken(); Locale disName =
