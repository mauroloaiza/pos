...
public class GuestChkBillDialog extends POSDialog {
	...
	private void initComponents() {
		...
		tableModel.addColumn("Ticket Id", "ticketId");
		tableModel.addColumn("Table #", "tableNo");
		tableModel.addColumn("Server", "user");
		tableModel.addColumn("Print", "printTime");
		tableModel.addColumn("Elapsed Time", "diffInBillPrint");
		...
		table.getColumnModel().getColumn(1).setCellRenderer(new DefaultTableCellRenderer() {
			...
			public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
				...
				if (value instanceof Date) {
					...
					return super.getTableCellRendererComponent(table, dateFormat.format(date), isSelected, hasFocus,
							row, column);
				}
				return super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
			}
