...
public class MultiCurrencyTenderDialog extends OkCancelOptionDialog {
	...
	private void init() {
		...
		JPanel inputPanel = new JPanel(
				new MigLayout("fill,ins 0", "[fill][right]30px[120px,grow,fill,right][120px,grow,fill,right][][]", ""));
	...
	class CurrencyRow implements ActionListener, FocusListener {
		...
		public CurrencyRow(Currency currency, double dueAmountInMainCurrency) {
			...
			lblRemainingBalance = getJLabel(NumberUtil.formatNumber(remainingBalance, currency.getDecimalPlaces()),
					Font.PLAIN, 16, JLabel.RIGHT);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (source == btnExact) {
				tfTenderdAmount.setText(
						String.valueOf(NumberUtil.formatNumber(remainingBalance, currency.getDecimalPlaces())));
			} else {
				tfTenderdAmount.setText(String
						.valueOf(NumberUtil.formatNumber(Math.ceil(remainingBalance), currency.getDecimalPlaces())));
			}
		}
