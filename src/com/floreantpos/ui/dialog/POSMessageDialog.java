...
public class POSMessageDialog {
	...
	public static int showYesNoQuestionDialog(Component parent, String message, String title, String yesButtonText,
			String noButtonText) {
	...
	public static void showMessageDialogWithReloadButton(Component parent, RefreshableView refreshView) {
		showMessageDialogWithReloadButton(parent, refreshView,
				"Data has been changed in other terminal. Please reload this window and try again.");
	}

	public static void showMessageDialogWithReloadButton(Component parent, RefreshableView refreshView, String msg) {
		// @formatter:off
		JOptionPane reloadPane = new JOptionPane(msg, JOptionPane.ERROR_MESSAGE, JOptionPane.YES_NO_OPTION, null,
		...
		JDialog dialog = reloadPane.createDialog(parent == null ? Application.getPosWindow() : parent,
