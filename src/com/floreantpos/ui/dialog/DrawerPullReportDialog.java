...
public class DrawerPullReportDialog extends POSDialog {
	...
	// private void doResetCashDrawer()
	// {//GEN-FIRST:event_btnResetCashDrawerActionPerformed
	// int option = POSMessageDialog.showYesNoQuestionDialog(this, "Sure reset
	// cash drawer?", "Confirm");
	...
	//
	// double drawerBalance = NumberSelectionDialog2.takeDoubleInput("Enter
	// amount", "Please enter drawer balance", terminal.getOpeningBalance());
	...
	void createReportHeader(Document document) {
		...
		p.addElement(new BR());
		p.addElement(
				Messages.getString("DrawerPullReportDialog.16") + Application.getInstance().getTerminal().getName()); //$NON-NLS-1$
		p.addElement(new BR());
		p.addElement("==================================="); //$NON-NLS-1$
	...
	public String createReport() throws Exception {
		...
		addTableRow(table, "&nbsp;" + Messages.getString("DrawerPullReportDialog.3"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getNetSales()));
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.5"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getSalesTax()));
		addTableRow(table, "+" + Messages.getString("SALES_DELIVERY_CHARGE"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getSalesDeliveryCharge()));
		addTableRow(table, "=" + Messages.getString("DrawerPullReportDialog.7"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getTotalRevenue()));
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.10"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getChargedTips()));
		addTableSeparator(table);
		addTableRow(table, "=" + Messages.getString("DrawerPullReportDialog.12"), //$NON-NLS-1$ //$NON-NLS-2$
		...
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.23"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getGiftCertChangeAmount()));
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.25"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getCashBack()));
		addTableRow(table, "+" + "REFUND" + " (" + drawerPullReport.getRefundReceiptCount() + ")", //$NON-NLS-1$ //$NON-NLS-3$ //$NON-NLS-4$
				decimalFormat.format(drawerPullReport.getRefundAmount()));
		addTableSeparator(table);
		addTableRow(table, "=" + Messages.getString("DrawerPullReportDialog.29"), //$NON-NLS-1$ //$NON-NLS-2$
		...
		table = new Table();
		table.addAttribute("width", "100%"); //$NON-NLS-1$ //$NON-NLS-2$
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.31"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getChargedTips()));
		addTableRow(table, "-" + Messages.getString("DrawerPullReportDialog.33"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getTipsPaid()));
		addTableSeparator(table);
		addTableRow(table, "=" + Messages.getString("DrawerPullReportDialog.35"), //$NON-NLS-1$ //$NON-NLS-2$
		...
		table = new Table();
		table.addAttribute("width", "100%"); //$NON-NLS-1$ //$NON-NLS-2$
		addTableRow(table, "CASH" + " (" + drawerPullReport.getCashReceiptCount() + ")", //$NON-NLS-2$ //$NON-NLS-3$
				decimalFormat.format(drawerPullReport.getCashReceiptAmount()));
		// addTableRow(table, "CASH TAX",
		// decimalFormat.format(drawerPullReport.getCashTax()));
		addTableRow(table, "-" + Messages.getString("DrawerPullReportDialog.39"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getTipsPaid()));
		addTableRow(table, "-" + "PAY OUT" + "       (" + drawerPullReport.getPayOutCount() + ")", //$NON-NLS-1$ //$NON-NLS-3$ //$NON-NLS-4$
				decimalFormat.format(drawerPullReport.getPayOutAmount()));
		addTableRow(table, "-" + Messages.getString("DrawerPullReportDialog.43"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getCashBack()));
		addTableRow(table, "-" + "REFUND" + " (" + drawerPullReport.getRefundReceiptCount() + ")", //$NON-NLS-1$ //$NON-NLS-3$ //$NON-NLS-4$
				decimalFormat.format(drawerPullReport.getRefundAmount()));
		addTableRow(table, "+" + Messages.getString("DrawerPullReportDialog.47"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(terminal.getOpeningBalance()));
		...
		addTableSeparator(table);
		addTableRow(table, "=" + Messages.getString("DrawerPullReportDialog.51"), //$NON-NLS-1$ //$NON-NLS-2$
				decimalFormat.format(drawerPullReport.getDrawerAccountable()));
		addTableRow(table, ">" + Messages.getString("DrawerPullReportDialog.53"), //$NON-NLS-1$ //$NON-NLS-2$
			...
			if (cashDrawer != null) {
				if (cashDrawer.getCurrencyBalanceList() != null) {
					for (CurrencyBalance currencyBalance : cashDrawer.getCurrencyBalanceList()) {
						addTableRow(table, currencyBalance.getCurrency().getName() + "", //$NON-NLS-1$
								"" + decimalFormat.format(currencyBalance.getBalance())); //$NON-NLS-1$
					}
				}
			}
		}
		...
		table = new Table();
		table.addAttribute("width", "100%"); //$NON-NLS-1$ //$NON-NLS-2$
		addExceptionTableRow(table, Messages.getString("DrawerPullReportDialog.99"), //$NON-NLS-1$
				Messages.getString("DrawerPullReportDialog.100"), //$NON-NLS-1$
		...
		if (voidTickets != null) {
			for (DrawerPullVoidTicketEntry entry : voidTickets) {
				addExceptionTableRow(table, String.valueOf(entry.getCode()), entry.getReason(), entry.getHast(),
						NumberUtil.formatNumber(entry.getAmount()));
			}
		}
		addExceptionTableSeparator(table);
		document.appendBody(table);
		...
		table = new Table();
		table.addAttribute("width", "100%"); //$NON-NLS-1$ //$NON-NLS-2$
		addTableRow(table, Messages.getString("DrawerPullReportDialog.105"), //$NON-NLS-1$
				decimalFormat.format(drawerPullReport.getTotalVoidWst()));
		addTableRow(table, Messages.getString("DrawerPullReportDialog.106"), //$NON-NLS-1$
				decimalFormat.format(drawerPullReport.getTotalVoid()));
		...
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.112"), //$NON-NLS-1$
				String.valueOf(drawerPullReport.getTotalDiscountCount()));
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.113"), //$NON-NLS-1$
				NumberUtil.formatNumber(drawerPullReport.getTotalDiscountAmount()));
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.114"), //$NON-NLS-1$
				NumberUtil.formatNumber(drawerPullReport.getTotalDiscountSales()));
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.115"), //$NON-NLS-1$
				String.valueOf(drawerPullReport.getTotalDiscountGuest()));
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.116"), //$NON-NLS-1$
				String.valueOf(drawerPullReport.getTotalDiscountPartySize()));
		addDiscountTableRow(table, Messages.getString("DrawerPullReportDialog.117"), //$NON-NLS-1$
	...
	private void doPrintReport() {
		try {
			...
			POSMessageDialog.showError(DrawerPullReportDialog.this,
					Messages.getString("DrawerPullReportDialog.122") + ex.getMessage()); //$NON-NLS-1$
