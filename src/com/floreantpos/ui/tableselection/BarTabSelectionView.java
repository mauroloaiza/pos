...
public class BarTabSelectionView extends JPanel {
	...
	private void init() {
		...
		TitledBorder titledBorder1 = BorderFactory.createTitledBorder(null, "Bar Tab Tickets", TitledBorder.CENTER,
	...
	private void rendererBarTickets() {
		...
		for (Ticket ticket : openTickets) {
			...
			barTabButton.setText("<html><center>" + customerName + "<br><h4 style='margin:0px;'>" //$NON-NLS-1$ //$NON-NLS-2$
					+ ticket.getOwner().getFirstName() + "<br>Chk#" //$NON-NLS-1$
					+ ticket.getId() + "</h4>" + CurrencyUtil.getCurrencySymbol() + ticket.getTotalAmount() //$NON-NLS-1$
					+ "<br><small style='margin:0px;'>Due: "
