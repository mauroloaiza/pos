...
public class HeaderPanel extends JPanel {
	...
	public HeaderPanel() {
		// super(new MigLayout("ins 2 2 0 2,hidemode 3", "[][fill, grow][]",
		...
		// add(new JSeparator(JSeparator.HORIZONTAL), "newline, span 7, grow,
		// gap 0"); //$NON-NLS-1$
	 ...
	 * btnOthers.setVisible(!viewName.equals(SwitchboardOtherFunctionsView.
	 * VIEW_NAME)); }
	 * 
