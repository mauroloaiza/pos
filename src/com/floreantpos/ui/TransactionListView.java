		...
		public TransactionListTableModel() {
			super(
					...
					new String[] { Messages.getString("TransactionListView.0"),
							Messages.getString("TransactionListView.10"), Messages.getString("TransactionListView.1"),
							// Messages.getString("TransactionListView.8"),
							Messages.getString("TransactionListView.8"), Messages.getString("TransactionListView.2"),
							"CARD NO.", "AUTH CODE", Messages.getString("TransactionListView.4"), "TIP OVERAGE",
							Messages.getString("TransactionListView.5"), Messages.getString("TransactionListView.6") }); //$NON-NLS-2$ //$NON-NLS-2$
																															// //$NON-NLS-3$
																															// //$NON-NLS-4$
																															// //$NON-NLS-5$
																															// //$NON-NLS-6$
