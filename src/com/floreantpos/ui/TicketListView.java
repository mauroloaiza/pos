	...
	private class TicketListTableModel extends PaginatedTableModel {
		public TicketListTableModel() {
			super(new String[] { POSConstants.TICKET_LIST_COLUMN_ID, POSConstants.TICKET_LIST_COLUMN_TABLE,
					...
					POSConstants.TICKET_LIST_COLUMN_DELIVERY_DATE, POSConstants.TICKET_LIST_COLUMN_TICKET_TYPE,
					POSConstants.TICKET_LIST_COLUMN_STATUS, POSConstants.TICKET_LIST_COLUMN_TOTAL,
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			case 8:
				...
				/*
				 * if (ticket.getType().isRequiredCustomerData()) {//fix if
				 * (ticket.getAssignedDriver() == null) { status +=
				 * Messages.getString("TicketListView.10"); //$NON-NLS-1$ }
				 * 
				 * status += Messages.getString("TicketListView.11");
				 * //$NON-NLS-1$ }
				 */
