...
public class OrderFilterPanel extends JXCollapsiblePane {
	...
	/*
	 * private POSToggleButton btnCustomerFilterByOpenStatus; private
	 * POSToggleButton btnCustomerAllStatus;
	 */
	...
	/*
	 * public OrderFilterPanel(final ITicketList ticketList, final Integer
	 * memberId) { this.ticketList = ticketList; setCollapsed(true);
	 * getContentPane().setLayout(new MigLayout("fill", "fill, grow", ""));
	 * //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 * 
	 * btnCustomerFilterByOpenStatus = new
	 * POSToggleButton(PaymentStatusFilter.OPEN.toString());
	 ...
	 * TerminalConfig.getCustomerPaymentStatusFilter();
	 * 
	 * switch (paymentStatusFilter) { case "OPEN":
	 * btnCustomerFilterByOpenStatus.setSelected(true); break;
	 * 
	 * default: btnCustomerAllStatus.setSelected(true); break; }
	 * 
	 ...
	 * 
	 * String filter = actionCommand.replaceAll("\\s", "_"); //$NON-NLS-1$
	 * //$NON-NLS-2$ TerminalConfig.setCustomerPaymentStatusFilter(filter);
	 * 
	 ...
	 * 
	 * JPanel filterByPaymentStatusPanel = new JPanel(new MigLayout("", "",
	 * "")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 * filterByPaymentStatusPanel.setBorder(new
	 * TitledBorder(Messages.getString("SwitchboardView.3"))); //$NON-NLS-1$
