...
public class UserForm extends BeanEditor {
	...
	private void initComponents() {
		...
		cbUserType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { Messages.getString("UserForm.33"), //$NON-NLS-1$
				Messages.getString("UserForm.34"), Messages.getString("UserForm.35") })); //$NON-NLS-1$ //$NON-NLS-2$
		...
		if (!editMode) {
			if (userDAO.isUserExist(user.getUserId())) {
				POSMessageDialog.showError(this,
						Messages.getString("UserForm.39") + user.getUserId() + " " + Messages.getString("UserForm.1")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				return false;
			}
		}
	...
	protected boolean updateModel() throws IllegalModelStateException {
		...
		try {
			...
			throw new IllegalModelStateException(Messages.getString("UserForm.49") + firstName + " " + lastName + " " //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
					+ Messages.getString("UserForm.2")); //$NON-NLS-1$
		}
