...
public class TicketItemRowCreator {
	...
	public static void calculateTicketRows(Ticket ticket, Map<String, ITicketItem> tableRows, boolean includeModifiers,
			boolean includeAddOns, boolean includeCookingInstructions) {
		calculateTicketRows(ticket, tableRows, true, true, true, true);
	}

	public static void calculateTicketRows(Ticket ticket, Map<String, ITicketItem> tableRows, boolean includeModifiers,
			boolean includeAddOns, boolean includeCookingInstructions, boolean includeDiscounts) {
		tableRows.clear();
	...
	// public static void calculateKitchenTicketRows(KitchenTicket ticket,
	// Map<String, ITicketItem> tableRows) {
	// tableRows.clear();
	//
	// int rowNum = 0;
	//
	...
	private static int includeCookintInstructions(TicketItem ticketItem, Map<String, ITicketItem> tableRows,
			int rowNum) {
	...
	private static int includeModifiers(TicketItem ticketItem, Map<String, ITicketItem> tableRows, int rowNum,
			boolean kitchenPrint) {
