...
public class TicketViewerTableModel extends AbstractTableModel {
	...
	protected String[] columnNames = { Messages.getString("TicketViewerTableModel.2"), //$NON-NLS-1$
			Messages.getString("TicketViewerTableModel.0"), //$NON-NLS-1$
			/* Messages.getString("TicketViewerTableModel.1"), */Messages.getString("TicketViewerTableModel.3") }; //$NON-NLS-1$ //$NON-NLS-4$
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		/*
		 * case 1: return ticketItem.getUnitPriceDisplay();
		 */
	...
	public Object delete(int index) {
		...
		if (object instanceof TicketItem) {
			...
			// for (Iterator iterator = ticketItemModifiers.iterator();
			// iterator.hasNext();) {
			// TicketItemModifier element = (TicketItemModifier)
			// iterator.next();
