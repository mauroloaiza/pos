...
public class TodoTicketViewerTableModel extends AbstractTableModel {
	...
	protected String[] columnNames = { Messages.getString("TodoTicketViewerTableModel.0"), //$NON-NLS-1$
			Messages.getString("TodoTicketViewerTableModel.1"), Messages.getString("TodoTicketViewerTableModel.2"), //$NON-NLS-1$ //$NON-NLS-2$
			Messages.getString("TodoTicketViewerTableModel.3"), Messages.getString("TodoTicketViewerTableModel.4") }; //$NON-NLS-1$ //$NON-NLS-2$
	...
	public Object delete(int index) {
		...
		// TicketItemCookingInstruction cookingInstruction =
		// (TicketItemCookingInstruction) iTicketItem;
