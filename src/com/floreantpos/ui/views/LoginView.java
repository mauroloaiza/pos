...
public class LoginView extends ViewPanel {
	...
	private LoginView() {
		...
		centerPanel.setLayout(new MigLayout("al center center", "sg fill", String.valueOf(height))); //$NON-NLS-1$ //$NON-NLS-2$
																										// //$NON-NLS-3$
	...
	private JPanel createCenterPanel() {
		...
		// lblTerminalId = new JLabel(Messages.getString("LoginView.0"));
		// //$NON-NLS-1$
		// lblTerminalId.setForeground(Color.BLACK);
		// lblTerminalId.setFont(new Font("Dialog", Font.BOLD,
		// PosUIManager.getFontSize(18))); //$NON-NLS-1$
	...
	public synchronized void doLogin() {
		try {
			final User user = PasswordEntryDialog.getUser(Application.getPosWindow(), Messages.getString("LoginView.1"), //$NON-NLS-1$
					Messages.getString("LoginView.2")); //$NON-NLS-1$
			if (user == null) {
	...
	public void setTerminalId(int terminalId) {
		// lblTerminalId.setText(Messages.getString("LoginView.6") +
		// terminalId); //$NON-NLS-1$
	}
