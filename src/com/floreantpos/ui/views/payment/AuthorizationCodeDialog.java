...
public class AuthorizationCodeDialog extends POSDialog implements CardInputProcessor {
	...
	private void createUI() {
		...
		creditCardPanel.setBorder(new CompoundBorder(
				new TitledBorder(Messages.getString("PaymentTypeSelectionDialog.4")), new EmptyBorder(10, 10, 10, 10))); //$NON-NLS-1$
		...
		debitCardPanel.setBorder(new CompoundBorder(
				new TitledBorder(Messages.getString("PaymentTypeSelectionDialog.6")), new EmptyBorder(10, 10, 10, 10))); //$NON-NLS-1$
