...
public class GroupPaymentView extends JPanel {
	...
	private void initComponents() {
		...
		btn7.setText("7");
		btn7.setFont(font2);
		// btn7.setIcon(IconFactory.getIcon("/ui_icons/", "7.png")); // NOI18N
		// //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn8.setText("8");
		btn8.setFont(font2);
		// btn8.setIcon(IconFactory.getIcon("/ui_icons/", "8.png")); // NOI18N
		// //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn0.setText("0");
		btn0.setFont(font2);
		// btn0.setIcon(IconFactory.getIcon("/ui_icons/", "0.png")); // NOI18N
		// //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected boolean adjustCashDrawerBalance(List<Currency> currencyList) {
		MultiCurrencyTenderDialog dialog = new MultiCurrencyTenderDialog(groupSettleTicketView.getTickets(),
				currencyList);
		dialog.pack();
		dialog.open();
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (command.equals("exactAmount")) { //$NON-NLS-1$
					...
					double x = NumberUtil.parse(txtTenderedAmount.getText()).doubleValue();// FIXME:
																							// what
																							// if
																							// exception
																							// occurs?
