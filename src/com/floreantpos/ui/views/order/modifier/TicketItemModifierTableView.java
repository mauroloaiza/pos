...
public class TicketItemModifierTableView extends JPanel {
	...
	// private com.floreantpos.swing.PosButton btnIncreaseAmount = new
	// PosButton(IconFactory.getIcon("/ui_icons/", "add_user.png"));
	// //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void createTicketItemControlPanel() {
		...
		// btnIncreaseAmount.addActionListener(new
		...
		// });
		//
		// btnDecreaseAmount.setIcon(IconFactory.getIcon("/ui_icons/",
		// "minus.png")); //$NON-NLS-1$ //$NON-NLS-2$
		// btnDecreaseAmount.addActionListener(new
		// java.awt.event.ActionListener() {
		// public void actionPerformed(java.awt.event.ActionEvent evt) {
	...
	private void updateSelectionView() {
		...
		//
		// ModifierSelectionDialog modifierSelectionView =
		// ModifierSelectionDialog.getInstance();
		//
