...
public class ModifierViewerTableModel extends AbstractTableModel {
	...
	protected String[] columnNames = { Messages.getString("TicketViewerTableModel.0"), //$NON-NLS-1$
			/*
			 * Messages.getString("TicketViewerTableModel.1"),
			 * Messages.getString("TicketViewerTableModel.2"),
			 */Messages.getString("TicketViewerTableModel.3") }; //$NON-NLS-1$ //$NON-NLS-3$
																// //$NON-NLS-4$
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		 ...
		 * 
		 * case 2: return ticketItem.getItemQuantityDisplay();
		 */
