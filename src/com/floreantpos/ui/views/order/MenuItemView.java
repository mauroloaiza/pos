		...
		private void updateView(MenuItem menuItem) {
			...
			if (menuItem.getImage() != null) {
				...
				if (menuItem.isShowImageOnly()) {
					...
					setIcon(menuItem.getScaledImage(w, h));
					setText("<html><body><center><span style='font-size:7px;margin:0px;'>" + menuItem.getDisplayName() //$NON-NLS-1$
							+ "</span></center></body></html>"); //$NON-NLS-1$
				}
				...
				if (menuItem.getId() == null) {
					...
					setText("<html><body><center>" + menuItem.getName()
							...
							+ "&nbsp;"
							+ (!showStockCount ? ""
									: "<span style='color:white;background-color:red;margin:1;'>" + "&nbsp;" + "&nbsp;"
											+ "&nbsp;" + menuItem.getStockAmount() + "&nbsp;" + "&nbsp;" + "&nbsp;" //$NON-NLS-2$//$NON-NLS-3$
											+ "</span>")
							+ "</h4>" + "</center></body></html>");
			}
