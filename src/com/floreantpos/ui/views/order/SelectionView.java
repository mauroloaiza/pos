...
public abstract class SelectionView extends JPanel implements ComponentListener {
	...
	protected void renderItems() {
		...
		// buttonsPanel.setLayout(new MigLayout("alignx 50%, wrap " +
		// horizontalButtonCount)); //$NON-NLS-1$
	...
	public void addSeparator(String text) {
		cardLayoutContainer.add(new JXTitledSeparator(text, JLabel.CENTER),
				"alignx 50%, newline, span, growx, height 30!"); //$NON-NLS-1$
	}
	...
	protected int getButtonCount(int containerSize, int itemSize) {
		...
		// buttonCount = (containerSize - ((containerSize / itemSize) * 5)) /
		// itemSize;
		return buttonCount;
	}
