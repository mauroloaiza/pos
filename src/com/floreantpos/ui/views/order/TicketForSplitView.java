...
public class TicketForSplitView extends com.floreantpos.swing.TransparentPanel implements TableModelListener {
	...
	public void updateModel() {
		 ...
		 * double calculatedTax = ticket.getCalculatedTax(); double
		 * calculatedTotalPrice = ticket.getCalculatedTotalPrice();
		 * 
	...
	public void transferTicketItem(TicketItem ticketItem, TicketForSplitView toTicketView, boolean fullTicketItem) {
		...
		// newTicketItem.setTicketItemModifierGroups(new
		// ArrayList<TicketItemModifierGroup>(ticketItem.getTicketItemModifierGroups()));
		...
		// for (TicketItemModifierGroup modifierGroup :
