...
public class SwitchboardOtherFunctionsDialog extends POSDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		// private PosButton btnBackOffice = new
		// PosButton(POSConstants.BACK_OFFICE_BUTTON_TEXT);
		// private PosButton btnManager = new
		// PosButton(POSConstants.MANAGER_BUTTON_TEXT);
		// private PosButton btnAuthorize = new
		// PosButton(POSConstants.AUTHORIZE_BUTTON_TEXT);
		// private PosButton btnKitchenDisplay = new
		// PosButton(POSConstants.KITCHEN_DISPLAY_BUTTON_TEXT);
		// private PosButton btnPayout = new
		// PosButton(POSConstants.PAYOUT_BUTTON_TEXT);
		// private PosButton btnTableManage = new
		// PosButton(POSConstants.TABLE_MANAGE_BUTTON_TEXT);
		// private PosButton btnOnlineTickets = new
		// PosButton(POSConstants.ONLINE_TICKET_BUTTON_TEXT);
