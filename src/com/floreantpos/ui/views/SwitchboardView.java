...
public class SwitchboardView extends ViewPanel implements ActionListener, ITicketList, TicketListUpdateListener {
	...
	// com.floreantpos.POSConstants.SWITCHBOARD;
	...
	protected void doCloseOrder() {
		...
		// Messages.getString("SwitchboardView.5")); //$NON-NLS-1$
		// return;
		// }
		...
		if (userType != null) {
			...
			if (permissions != null) {
				...
				for (UserPermission permission : permissions) {
					 ...
					 * btnTakeout.setEnabled(true); } else if
					 * (permission.equals(UserPermission.CREATE_TICKET)) {
	...
	// private PosButton btnBarTab = new
	// PosButton(POSConstants.BAR_TAB_BUTTON_TEXT);
	...
	// private PosBlinkButton btnRefreshTicketList = new
	// PosBlinkButton(Messages.getString(Messages.getString("SwitchboardView.21")));
	// //NON-NLS-1$ //$NON-NLS-1$
