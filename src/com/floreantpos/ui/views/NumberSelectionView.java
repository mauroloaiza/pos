...
public class NumberSelectionView extends TransparentPanel implements ActionListener {
	...
	private void initComponents() {
		 ...
		 * btnClearAll.setPreferredSize(new Dimension(PosUIManager.getSize(90,
		 * 50))); btnClearAll.addActionListener(this);
		...
		String[][] numbers = { { "7", "8", "9" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				...
				{ ".", "0", com.floreantpos.POSConstants.CLEAR_ALL } //$NON-NLS-1$ //$NON-NLS-2$
																		// //$NON-NLS-3$
		};
