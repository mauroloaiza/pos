...
public class OrderTypeForm extends BeanEditor implements ItemListener {
	...
	private void initComponents() {
		...
		OrderServiceExtension orderServiceExtension = (OrderServiceExtension) ExtensionManager
		...
		// generalPanel.add(chkShowUnitPriceInTicketGrid, "cell 1 19,alignx
		// left,aligny top"); //$NON-NLS-1$
