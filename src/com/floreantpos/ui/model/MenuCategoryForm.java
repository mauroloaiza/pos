	...
	private void initComponents() {
		...
		btnButtonColor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuCategoryForm.this, Messages.getString("MenuCategoryForm.21"), //$NON-NLS-1$
		...
		btnTextColor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuCategoryForm.this, Messages.getString("MenuCategoryForm.22"), //$NON-NLS-1$
