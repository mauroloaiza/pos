...
public class MenuModifierForm extends BeanEditor {
	...
	private void initComponents() {
		...
		// lelfInputPanel.add(lblPrice, "alignx left,aligny center");
		// //$NON-NLS-1$
		// lelfInputPanel.add(tfNormalPrice, "growx,aligny top"); //$NON-NLS-1$

		// lelfInputPanel.add(lblExtraPrice, "alignx left,aligny center");
		// //$NON-NLS-1$
		...
		btnButtonColor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuModifierForm.this, Messages.getString("MenuModifierForm.39"), //$NON-NLS-1$
		...
		btnTextColor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuModifierForm.this, Messages.getString("MenuModifierForm.40"), //$NON-NLS-1$
		...
		// lelfInputPanel.add(chkSelectAll, "newline,gapleft 10,skip 1,split
		// 2,grow");
		...
		if (TerminalConfig.isMultipleOrderSupported()) {
			// jTabbedPane1.addTab(Messages.getString("MenuModifierForm.6"),
			// tabPrice); //$NON-NLS-1$
		}
	}
