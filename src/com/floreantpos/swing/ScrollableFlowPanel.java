...
public class ScrollableFlowPanel extends JPanel implements Scrollable {
	...
	class ScrollableFlowLayout extends FlowLayout {
		 ...
		 * component take its preferred size by reshaping the components in the
		 * target container in order to satisfy the alignment of this
		...
		public void layoutContainer(Container target) {
			synchronized (target.getTreeLock()) {
				...
				layoutHeight += moveComponents(target, insets.left + getHgap(), y, maxwidth - x, rowh, start, nmembers,
						ltr, useBaseline, ascent, descent);
