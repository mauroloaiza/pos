...
public class ShopTableButton extends PosButton {
	...
	public void update() {
		...
		setText("<html><center><b>" + shopTable.toString() + "<small>" + userName + ticketIdAsString //$NON-NLS-1$
				+ "</small></center></b></html>");
	...
	public boolean hasUserAccess() {
		...
		if (currentUser.hasPermission(UserPermission.PERFORM_MANAGER_TASK)
				|| currentUser.hasPermission(UserPermission.PERFORM_ADMINISTRATIVE_TASK)) {
			return true;
		}
