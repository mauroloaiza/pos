...
public enum Database {
	DERBY_SINGLE(Messages.getString("Database.DERBY_SINGLE"), "jdbc:derby:database/derby-single/posdb", //$NON-NLS-1$ //$NON-NLS-2$
			"jdbc:derby:database/derby-single/posdb;create=true", "", "org.apache.derby.jdbc.EmbeddedDriver", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"org.hibernate.dialect.DerbyDialect"), //$NON-NLS-1$
	DERBY_SERVER(Messages.getString("Database.DERBY_SERVER"), "jdbc:derby://<host>:<port>/<db>", //$NON-NLS-1$ //$NON-NLS-2$
			"jdbc:derby://<host>:<port>/<db>;create=true", "51527", "org.apache.derby.jdbc.ClientDriver", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"org.hibernate.dialect.DerbyDialect"), //$NON-NLS-1$
	MYSQL(Messages.getString("Database.MYSQL"), "jdbc:mysql://<host>:<port>/<db>?characterEncoding=UTF-8", //$NON-NLS-1$ //$NON-NLS-2$
			"jdbc:mysql://<host>:<port>/<db>?characterEncoding=UTF-8", "3306", "com.mysql.jdbc.Driver", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"org.hibernate.dialect.MySQLDialect"), //$NON-NLS-1$
	POSTGRES(Messages.getString("Database.POSTGRES"), "jdbc:postgresql://<host>:<port>/<db>", //$NON-NLS-1$ //$NON-NLS-2$
			"jdbc:postgresql://<host>:<port>/<db>", "5432", "org.postgresql.Driver", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
