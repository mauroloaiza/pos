...
public abstract class BaseCustomer implements Comparable, Serializable {
	 ...
	 *            the SOCIAL_SECURITY_NUMBER value
	 */
	...
	public void setDeliveryInstructions(
			java.util.List<com.floreantpos.model.DeliveryInstruction> deliveryInstructions) {
