 ...
 *
 * @hibernate.class table="SHOP_TABLE_STATUS"
 */
...
public abstract class BaseShopTableStatus implements Comparable, Serializable {
	 ...
	 * 
	 * @param tableStatusNum
	 *            the TABLE_STATUS value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.floreantpos.model.ShopTableStatus))
			return false;
		else {
			...
			if (null == this.getId() || null == shopTableStatus.getId())
				...
				return (this.getId().equals(shopTableStatus.getId()));
		}
	}
