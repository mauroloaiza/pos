...
public abstract class BaseRestaurant implements Comparable, Serializable {
	 ...
	 * 
	 * @param serviceChargePercentage
	 *            the SC_PERCENTAGE value
	 */
	 ...
	 * 
	 * @param defaultGratuityPercentage
	 *            the GRATUITY_PERCENTAGE value
	 */
	 ...
	 * 
	 * @param ticketFooterMessage
	 *            the TICKET_FOOTER value
	 */
	 ...
	 * 
	 * @param itemPriceIncludesTax
	 *            the PRICE_INCLUDES_TAX value
	 */
	 ...
	 * 
	 * @param allowModifierMaxExceed
	 *            the ALLOW_MODIFIER_MAX_EXCEED value
	 */
