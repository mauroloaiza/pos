...
public abstract class BaseTicketItem implements Comparable, Serializable {
	 ...
	 * 
	 * @param inventoryHandled
	 *            the INVENTORY_HANDLED value
	 */
	 ...
	 * 
	 * @param stockAmountAdjusted
	 *            the STOCK_AMOUNT_ADJUSTED value
	 */
	 ...
	 * 
	 * @param pizzaSectionModeType
	 *            the PIZZA_SECTION_MODE value
	 */
