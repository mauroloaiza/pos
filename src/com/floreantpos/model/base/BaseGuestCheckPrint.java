 ...
 *
 * @hibernate.class table="GUEST_CHECK_PRINT"
 */
...
public abstract class BaseGuestCheckPrint implements Comparable, Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.floreantpos.model.GuestCheckPrint))
			return false;
		else {
			com.floreantpos.model.GuestCheckPrint guestCheckPrint = (com.floreantpos.model.GuestCheckPrint) obj;
			if (null == this.getId() || null == guestCheckPrint.getId())
				return false;
			else
				return (this.getId().equals(guestCheckPrint.getId()));
		}
	}
