...
public abstract class BaseMenuModifier implements Comparable, Serializable {
	 ...
	 * 
	 * @param shouldSectionWisePrice
	 *            the SECTION_WISE_PRICING value
	 */
	 ...
	 * 
	 * @param pizzaModifierPriceList
	 *            the pizzaModifierPriceList value
	 */
	public void setPizzaModifierPriceList(
			java.util.List<com.floreantpos.model.PizzaModifierPrice> pizzaModifierPriceList) {
	 ...
	 * 
	 * @param multiplierPriceList
	 *            the multiplierPriceList value
	 */
	public void setMultiplierPriceList(
			java.util.List<com.floreantpos.model.ModifierMultiplierPrice> multiplierPriceList) {
