...
public abstract class BaseOrderType implements Comparable, Serializable {
	 ...
	 */
	public BaseOrderType(java.lang.Integer id, java.lang.String name) {
	 ...
	 * 
	 * @param showTableSelection
	 *            the SHOW_TABLE_SELECTION value
	 */
	 ...
	 * 
	 * @param showGuestSelection
	 *            the SHOW_GUEST_SELECTION value
	 */
	 ...
	 *            the SHOULD_PRINT_TO_KITCHEN value
	 */
	 ...
	 * 
	 * @param requiredCustomerData
	 *            the REQUIRED_CUSTOMER_DATA value
	 */
	 ...
	 * 
	 * @param showItemBarcode
	 *            the SHOW_ITEM_BARCODE value
	 */
	 ...
	 * 
	 * @param showInLoginScreen
	 *            the SHOW_IN_LOGIN_SCREEN value
	 */
	 ...
	 * 
	 * @param consolidateItemsInReceipt
	 *            the CONSOLIDATE_TIEMS_IN_RECEIPT value
	 */
	 ...
	 * 
	 * @param allowSeatBasedOrder
	 *            the ALLOW_SEAT_BASED_ORDER value
	 */
	 ...
	 * 
	 * @param hideItemWithEmptyInventory
	 *            the HIDE_ITEM_WITH_EMPTY_INVENTORY value
	 */
	 ...
	 * 
	 * @param hasForHereAndToGo
	 *            the HAS_FORHERE_AND_TOGO value
	 */
	 ...
	 * 
	 * @param preAuthCreditCard
	 *            the PRE_AUTH_CREDIT_CARD value
	 */
	 ...
	 * 
	 * @param showPriceOnButton
	 *            the SHOW_PRICE_ON_BUTTON value
	 */
	 ...
	 * 
	 * @param showStockCountOnButton
	 *            the SHOW_STOCK_COUNT_ON_BUTTON value
	 */
	 ...
	 * 
	 * @param showUnitPriceInTicketGrid
	 *            the SHOW_UNIT_PRICE_IN_TICKET_GRID value
	 */
