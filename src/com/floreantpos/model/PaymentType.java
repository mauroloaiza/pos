...
public enum PaymentType {
	...
	// CASH("CASH"),
	CREDIT_CARD("CREDIT CARD"), DEBIT_CARD("DEBIT CARD"), DEBIT_VISA("VISA", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"visa_card.png"), DEBIT_MASTER_CARD("MASTER CARD", "master_card.png"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public boolean isSupported() {
		...
		default:
			return CardConfig.isSwipeCardSupported() || CardConfig.isManualEntrySupported()
