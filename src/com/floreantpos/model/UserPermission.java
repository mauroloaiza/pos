...
public class UserPermission extends BaseUserPermission {
	...
	public final static UserPermission VIEW_ALL_OPEN_TICKETS = new UserPermission("View All Open Ticket", //$NON-NLS-1$
			"UserPermission.1"); //$NON-NLS-1$
	public final static UserPermission VOID_TICKET = new UserPermission("Void Ticket", "UserPermission.3"); //$NON-NLS-1$ //$NON-NLS-2$
	public final static UserPermission PERFORM_ADMINISTRATIVE_TASK = new UserPermission("Perform Administrative Task", //$NON-NLS-1$
			"UserPermission.4"); //$NON-NLS-1$
	public final static UserPermission PERFORM_MANAGER_TASK = new UserPermission("Perform Manager Task", //$NON-NLS-1$
			"UserPermission.5"); //$NON-NLS-1$
	public final static UserPermission VIEW_BACK_OFFICE = new UserPermission("View Back Office", "UserPermission.6", //$NON-NLS-1$ //$NON-NLS-2$
			false);
	...
	public final static UserPermission MANAGE_TABLE_LAYOUT = new UserPermission("Manage Table Layout", //$NON-NLS-1$
			"UserPermission.20"); //$NON-NLS-1$
	public final static UserPermission TABLE_BOOKING = new UserPermission("Booking", "UserPermission.22"); //$NON-NLS-1$ //$NON-NLS-2$
	public final static UserPermission MODIFY_PRINTED_TICKET = new UserPermission("Modify Printed Ticket", //$NON-NLS-1$
			"UserPermission.21"); //$NON-NLS-1$
	...
	// public final static UserPermission VIEW_USER_LIST = new
	// UserPermission("View User List");
	// public final static UserPermission GRATUITY_ADMINISTRATION = new
	// UserPermission("Gratuity Administration");
	// public final static UserPermission VIEW_DRAWER_PULL_REPORT = new
	// UserPermission("View Drawer Pull Report");
