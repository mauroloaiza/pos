...
public class DrawerPullReport extends BaseDrawerPullReport {
	...
	public void calculate() {
		...
		double total = getCashReceiptAmount() + getCreditCardReceiptAmount() + getDebitCardReceiptAmount()
				+ getGiftCertReturnAmount() + getGiftCertChangeAmount() - getCashBack() - getRefundAmount();
