...
public abstract class BaseUserDAO extends com.floreantpos.model.dao._RootDAO {
	...
	public com.floreantpos.model.User get(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.User) get(getReferenceClass(), key);
	}

	public com.floreantpos.model.User get(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.User) get(getReferenceClass(), key, s);
	}

	public com.floreantpos.model.User load(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.User) load(getReferenceClass(), key);
	}

	public com.floreantpos.model.User load(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public java.lang.Integer save(com.floreantpos.model.User user) throws org.hibernate.HibernateException {
	 ...
	 * @return the class identifier
	 */
	public java.lang.Integer save(com.floreantpos.model.User user, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public void saveOrUpdate(com.floreantpos.model.User user) throws org.hibernate.HibernateException {
	 ...
	 *            the Session.
	 */
	public void saveOrUpdate(com.floreantpos.model.User user, Session s) throws org.hibernate.HibernateException {
	 ...
	 *            Session
	 */
	public void update(com.floreantpos.model.User user, Session s) throws org.hibernate.HibernateException {
	 ...
	 *            the Session
	 */
	public void delete(com.floreantpos.model.User user, Session s) throws org.hibernate.HibernateException {
	 ...
	 * </ul>
	 */
	public void refresh(com.floreantpos.model.User user, Session s) throws org.hibernate.HibernateException {
