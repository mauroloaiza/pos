...
public abstract class BaseTaxDAO extends com.floreantpos.model.dao._RootDAO {
	...
	public com.floreantpos.model.Tax get(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Tax) get(getReferenceClass(), key);
	}

	public com.floreantpos.model.Tax get(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Tax) get(getReferenceClass(), key, s);
	}

	public com.floreantpos.model.Tax load(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Tax) load(getReferenceClass(), key);
	}

	public com.floreantpos.model.Tax load(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public java.lang.Integer save(com.floreantpos.model.Tax tax) throws org.hibernate.HibernateException {
	 ...
	 * @return the class identifier
	 */
	public java.lang.Integer save(com.floreantpos.model.Tax tax, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public void saveOrUpdate(com.floreantpos.model.Tax tax) throws org.hibernate.HibernateException {
	 ...
	 *            the Session.
	 */
	public void saveOrUpdate(com.floreantpos.model.Tax tax, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public void update(com.floreantpos.model.Tax tax) throws org.hibernate.HibernateException {
		update((Object) tax);
	}
	 ...
	 *            Session
	 */
	public void update(com.floreantpos.model.Tax tax, Session s) throws org.hibernate.HibernateException {
		update((Object) tax, s);
	}
	 ...
	 */
	public void delete(com.floreantpos.model.Tax tax) throws org.hibernate.HibernateException {
		delete((Object) tax);
	}
	 ...
	 *            the Session
	 */
	public void delete(com.floreantpos.model.Tax tax, Session s) throws org.hibernate.HibernateException {
		delete((Object) tax, s);
	}
	 ...
	 * </ul>
	 */
	public void refresh(com.floreantpos.model.Tax tax, Session s) throws org.hibernate.HibernateException {
