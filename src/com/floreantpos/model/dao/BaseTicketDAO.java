...
public abstract class BaseTicketDAO extends com.floreantpos.model.dao._RootDAO {
	...
	public com.floreantpos.model.Ticket get(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Ticket) get(getReferenceClass(), key);
	}

	public com.floreantpos.model.Ticket get(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Ticket) get(getReferenceClass(), key, s);
	}

	public com.floreantpos.model.Ticket load(java.lang.Integer key) throws org.hibernate.HibernateException {
		return (com.floreantpos.model.Ticket) load(getReferenceClass(), key);
	}

	public com.floreantpos.model.Ticket load(java.lang.Integer key, Session s) throws org.hibernate.HibernateException {
	 ...
	 */
	public java.lang.Integer save(com.floreantpos.model.Ticket ticket) throws org.hibernate.HibernateException {
	 ...
	 */
	public void saveOrUpdate(com.floreantpos.model.Ticket ticket) throws org.hibernate.HibernateException {
	 ...
	 *            the Session.
	 */
	public void saveOrUpdate(com.floreantpos.model.Ticket ticket, Session s) throws org.hibernate.HibernateException {
	 ...
	 *            Session
	 */
	public void update(com.floreantpos.model.Ticket ticket, Session s) throws org.hibernate.HibernateException {
	 ...
	 *            the Session
	 */
	public void delete(com.floreantpos.model.Ticket ticket, Session s) throws org.hibernate.HibernateException {
	 ...
	 * </ul>
	 */
	public void refresh(com.floreantpos.model.Ticket ticket, Session s) throws org.hibernate.HibernateException {
