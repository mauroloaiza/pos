...
public class KitchenTicketListPanel extends JPanel implements ComponentListener {
	...
	protected JPanel actionButtonPanel = new JPanel(
			new MigLayout("center,fillx,hidemode 3, ins 0 8 0 5", "sg, fill", "[30]")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void renderItems() {
		try {
			...
			selectionButtonsPanel
					.setLayout(new MigLayout(parentConstraints + ", wrap " + horizontalPanelCount, "sg, fill", "")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
