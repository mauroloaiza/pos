...
public class Elements {
	// public final static Class[] classes = new Class[] { User.class,
	// Tax.class, MenuCategory.class, MenuGroup.class, MenuModifier.class,
	// MenuModifierGroup.class, MenuItem.class, MenuItemShift.class,
	// Restaurant.class, UserType.class, UserPermission.class, Shift.class };
