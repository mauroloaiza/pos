...
public class DrawerUtil {
	...
	public static void select10CPI() { // 10 characters per inch (condensed
										// available)
		print(ESC);
		print(P);
	}

	public static void select15CPI() { // 15 characters per inch (condensend not
										// available)
		print(ESC);
		print(g);
	}
	...
	public static void lineFeed() {
		...
		print(CR); // according to epson esc/p ref. manual always send carriage
					// return before line feed
		print(LINE_FEED);
	}

	public static void formFeed() {
		// post: ejects single sheet
		print(CR); // according to epson esc/p ref. manual it is recommended to
					// send carriage return before form feed
		print(FF);
	}
	...
	public static void kick() {
		...
		/*
		 * print(ESC); print(p); print((char)1); print(_25); print(_250);
		 * 
		 * print(ESC); print(p); print(_0); print((char)64); print((char)240);
		 * 
		 * print(ESC); print(p); print(_48); print(_55); print(_121);
		 */
