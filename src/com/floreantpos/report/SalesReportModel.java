...
public class SalesReportModel extends AbstractTableModel {
	...
	private String[] columnNames = { "Id", "Name", "Price", "QTY", "Total", "Dis", "Tax", "Tax Total", "Gross Total" };//$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
																														// //$NON-NLS-10$
