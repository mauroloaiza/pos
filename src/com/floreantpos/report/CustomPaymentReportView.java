...
public class CustomPaymentReportView extends JPanel {
	...
	private void viewReport() throws Exception {
		...
		List<CustomPaymentTransaction> transactions = (List<CustomPaymentTransaction>) PosTransactionDAO.getInstance()
				.findTransactions(CustomPaymentTransaction.class, fromDate, toDate);
		...
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, map,
				new JRTableModelDataSource(new CustomPaymentReportModel(transactions)));
