...
public class HourlyLaborReportView extends TransparentPanel {
	...
	private void viewReport() {
		...
		for (int i = 0; i < 24; i++) {
			...
			List<User> users = attendenceHistoryDAO.findNumberOfClockedInUserAtHour(fromDate, toDate, i, userType,
					terminal);
		...
		for (Shift shift : shifts) {
			...
			List<User> users = attendenceHistoryDAO.findNumberOfClockedInUserAtShift(fromDate, toDate, shift, userType,
					terminal);
		...
		try {
			...
			properties.put("shiftReportDatasource", //$NON-NLS-1$
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(cbTerminal,
				new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
						...
						new Dimension(147, 22), null, 0, false));
		btnGo = new JButton();
		btnGo.setText(com.floreantpos.POSConstants.GO);
		panel1.add(btnGo, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, 1,
		...
		panel1.add(label4, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
				GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
