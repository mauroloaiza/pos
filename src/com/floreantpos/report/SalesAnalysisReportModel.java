...
public class SalesAnalysisReportModel extends ListTableModel {
	...
	public SalesAnalysisReportModel(List<SalesAnalysisData> dataList) {
		super(new String[] { "shiftName", "categoryName", "count", "gross", "discount", "netSales", "avgGross", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
				"avgDiscount", "avgNet", "percentage" }, dataList); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
