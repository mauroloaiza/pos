...
public class SalesBalanceReportView extends JPanel {
	...
	private void viewReport(Date fromDate, Date toDate) throws Exception {
		...
		map.put("days", //$NON-NLS-1$
				String.valueOf((int) ((toDate.getTime() - fromDate.getTime()) * (1.15740741 * Math.pow(10, -8))) + 1));
		...
		// map.put("totalReceipts",
		// NumberUtil.formatNumber(report.getCreditCardReceiptsAmount()));
		// map.put("totalTips",
		// NumberUtil.formatNumber(report.getGrossTipsPaidAmount()));
