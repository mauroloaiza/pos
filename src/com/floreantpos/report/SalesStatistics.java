...
public class SalesStatistics {
	...
	public static class ShiftwiseDataTableModel extends ListTableModel {
		public ShiftwiseDataTableModel(List<ShiftwiseSalesTableData> list) {
			super(new String[] { POSConstants.DAYPART, "profitCenter", //$NON-NLS-1$
					POSConstants.CHECK, "Guest", //$NON-NLS-1$
					POSConstants.ENTER, POSConstants.SALES, POSConstants.AVGCHK, POSConstants.AVERAGE_GUEST,
					POSConstants.PERCENTAGE }, list);
		}
