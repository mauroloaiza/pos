...
public class CreditCardReportView extends JPanel {
	...
	private void viewReport() throws Exception {
		...
		List<CreditCardTransaction> transactions = (List<CreditCardTransaction>) PosTransactionDAO.getInstance()
				.findTransactions(null, CreditCardTransaction.class, fromDate, toDate);
