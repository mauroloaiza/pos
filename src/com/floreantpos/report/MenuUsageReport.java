...
public class MenuUsageReport {
	...
	public static class MenuUsageReportTableModel extends ListTableModel {
		...
		public MenuUsageReportTableModel(List<MenuUsageReportData> datas) {
			super(new String[] { "category", "count", "grossSale", "discount", "netSale", "avgSale", "profit", "cost", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$
					"percentage" }, datas); //$NON-NLS-1$
		}
