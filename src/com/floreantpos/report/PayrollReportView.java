...
public class PayrollReportView extends TransparentPanel {
	...
	private void viewReport() {
		 ...
		 * (userType.equalsIgnoreCase(com.floreantpos.POSConstants.ALL)) {
		 * userType = null; } Terminal terminal = null; if
		 * (cbTerminal.getSelectedItem() instanceof Terminal) { terminal =
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(label2, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
				GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		// final JLabel label3 = new JLabel();
		// label3.setText(com.floreantpos.POSConstants.TERMINAL);
		// panel1.add(label3, new GridConstraints(3, 0, 1, 1,
		...
		panel1.add(btnGo, new GridConstraints(0, 5, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, 1,
