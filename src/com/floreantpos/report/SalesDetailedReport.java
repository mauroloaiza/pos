...
public class SalesDetailedReport {
	...
	public void addCreditCardData(CreditCardTransaction t) {
		...
		// data.setNetTipsAmount(data.getNetTipsAmount() +
		// t.getGratuityAmount());
	}
	...
	public class CreditCardDataTableModel extends ListTableModel {
		public CreditCardDataTableModel() {
			setColumnNames(new String[] { "creditCard", "salesCount", "salesAmount", "returnCount", "returnAmount", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
					"netAmount", "netTipsAmount", "percentage" }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
